      ...
      <div className="ui four doubling stackable padded cards segment">
        <div className="ui card">
          ...
          <i className="quote left large blue icon centered"></i>
            ...
            through SkillSync.Thanks to their mentorship, I gained confidence,
            expanded my network, and achieved my professional goals. I highly
            recommend SkillSync to anyone seeking mentorship opportunities.
        ...
        <div className="ui card">
          ...
          <i className="quote left icon large red centered"></i>
            SkillSync has been a game-changer for me.Our mentoring sessions
        ...
        <div className="ui card">
          <blockquote className="card content">
            ...
            SkillSync exceeded my expectations in every way. As a recent
        ...
        <div className="ui card">
          <blockquote className="card content">
            <i className="quote left icon pink large centered"></i>Being part of SkillSync

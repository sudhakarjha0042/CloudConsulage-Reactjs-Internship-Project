      ...
      <div className="section">
        ...
        <ul className="ui content">
          <li className="ui header">
            ...
            high-quality support to mentees. SkillSync values excellence in
          ...
          <li className="ui header">
            ...
            mentees. SkillSync recognizes the importance of empathy in building
          ...
          <li className="ui header">
            ...
            and facilitate knowledge sharing. SkillSync encourages an inclusive
          ...
          <li className="ui header">
            ...
            broader community. SkillSync is driven by the desire to empower

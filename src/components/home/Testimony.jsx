      ...
      <Slider {...settings}>
        <div className="quote">
          ...
          <blockquote>
            ...
            SkillSync.Thanks to their mentorship, I gained confidence, expanded
            my network, and achieved my professional goals. I highly recommend
            SkillSync to anyone seeking mentorship opportunities.
        ...
        <div className="quote">
          ...
          <blockquote>
            ...
            invaluable resources. Undoubtedly, SkillSync has helped unlock my potential{" "}
        ...
        <div className="quote">
          ...
          <blockquote>
            ...
            SkillSync has been an incredible experience. The platform not only

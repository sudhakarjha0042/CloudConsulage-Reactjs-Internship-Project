      ...
      <footer className="footer">
        <div className="main-footer">
          <div className="footer-column">
            ...
            <ul>
              <li>
                <a href="/about">About SkillSync</a>
              </li>
              <li>
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="#">
                  <i className="mail icon"></i>support@SkillSync.com
                </a>
              </li>
              <li>
                <a href="#">
                  <i className="globe icon"></i>SkillSync.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="socials">
          <div>
            <a href="https://www.facebook.com/SkillSync/" target="_blank">
              <Icon name="facebook" size="large" color="blue" />
            </a>
          </div>
          <div>
            <a href="https://www.youtube.com/SkillSync/" target="_blank">
              <Icon name="youtube" size="large" color="red" />
            </a>
          </div>
          <div>
            <a href="https://twitter.com/SkillSync" target="_blank">
              <Icon name="twitter square" size="large" color="blue" />
            </a>
          </div>
          <div>
            <a href="https://www.instagram.com/SkillSync/" target="_blank">
